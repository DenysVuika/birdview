...
CREATE TABLE IF NOT EXISTS dependencies (project_id BLOB NOT NULL, package_id BLOB NOT NULL, name TEXT NOT NULL, version TEXT NOT NULL, dev INTEGER, npm_url TEXT);
