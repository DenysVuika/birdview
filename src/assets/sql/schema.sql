...
CREATE TABLE IF NOT EXISTS unit_tests (project_id INTEGER NOT NULL, path TEXT NOT NULL, url TEXT);
CREATE TABLE IF NOT EXISTS e2e_tests (project_id INTEGER NOT NULL, path TEXT NOT NULL, url TEXT);
